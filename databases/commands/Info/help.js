...
module.exports = {
    ...
    run: async (client, message, args, guildData, player, prefix) => {
        ...
        if (cmd.useage) {
          ...
          embed.setFooter("Rythm bot Music");
        }
    ...
    let helpmenu = new MessageEmbed()
        .setAuthor(`Music Help Panel`, ee.footericon)
        .setDescription(`
...
**${emoji.categories.AnimatedDiscord} Help related to Rythm bot Music's commands**
 ...
 `)
        ...
        .addComponents(
            new MessageSelectMenu()
                .setCustomId('helpop')
                .setPlaceholder('❯ Rythm bot Help Menu!')
                .addOptions([
                {
                ...
                {
                    label: 'Info Commands',
                    description: 'To get some imformation of Rythm Bot',
                    value: 'third',
                ...
                {
                    label: 'Settings',
                    description: 'Rythm bot Music Settings',
                    value: 'fifth',
